    ...
    <nav class="navbar navbar-static-top pl-30">
        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                ...
                <!-- User Account-->
                @php
                    $adminAvatar = App\Models\Admin::where('id', Auth::id())->first();
                @endphp
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown"
                        title="User">
                        <img src="{{ !empty($adminAvatar->profile_photo_path) ? asset($adminAvatar->profile_photo_path) : url('upload/no_image.jpg') }}"
                            alt="">
                    </a>
