            ...
            <div class="sign-in-page">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 sign-in">
                        <h4 class="">Sign in</h4>
                        <form method="POST" class="register-form outer-top-xs" id="login"
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="form-group">
                                <label class="info-title" for="">Name <span>*</span></label>
                                <input type="text" class="form-control unicase-form-control text-input" id="regname"
                                    name="regname">
                                @error('regname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
