...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            ...
            <td align="right">
                <pre class="font">
                Ecommerce Head Office <br>
               Email:support@ecommerce.gmail.com <br>
               Mob: 123456789 <br>
               52 Nguyen Si Sach, 15 Sub-district, Tan Binh District, Tp.HCM<br>
            </pre>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    @endphp
                    <strong>Address:</strong> {{ $divi }},{{ $dis }}.{{ $sta }} <br>
        ...
        <tbody>
            @foreach ($orderItem as $product)
                <tr class="font">
                    ...
                    <td align="center">
                        {{ str_replace(',', '.', number_format($product->product->selling_price)) }}vnd
                    </td>
                    <td align="center">
                        {{ str_replace(',', '.', number_format($product->product->selling_price * $product->qty)) }}vnd
                    </td>
                </tr>
            @endforeach
        ...
        <tr>
            <td align="right">
                <h2><span style="color: green;">Subtotal:</span>
                    {{ str_replace(',', '.', number_format($order->amount)) }}vnd</h2>
