...
<table class="table">
            ...
            <tr>
              <th> Order Status: </th>
               <th>   
                <span class="badge badge-pill badge-primary">{{ $order->status }} </span> </th>
            </tr>
            <tr>
              <th></th>
              <th>
       ...
       <tr>
               <td width="10%">
                  <label for=""><img src="{{ asset($product->product->product_thumbnail) }}" height="50px;" width="50px;"> </label>
                </td>

               <td width="20%">
                  <label for=""> {{ $product->product->product_name_en }}</label>
                </td>
         ...
         <td width="10%">
                  <label for="">{{ str_replace(',','.',number_format($product->price * $product->qty))}}đ</label>
                </td>
