            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        @if (Auth::check())
                            <li><a href="{{ route('wishlist') }}" id="wishlistCheck"><i
                                        class="icon fa fa-heart"></i>Wishlist</a></li>
                        @endif
                        <li><a href="{{ route('mycart') }}"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
                        <li><a href="{{ route('checkout') }}"><i class="icon fa fa-check"></i>Checkout</a></li>
                        <li><a href="" data-toggle="modal" data-target="#ordertracking"><i
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @else
                                    <li><a href="{{ route('vietnamese.language') }}">Vietnamese</a></li>
                                @endif
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="search-area">
                        <form action="{{ route('product.search') }}" method="POST">
                            ...
                            <div class="control-group">
                                ...
                                <input class="search-field" onfocus="search_ajax_show()" onblur="search_ajax_hide()"
                                    id="search" name="search" style="width: 90%;" placeholder="Search here..." />
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart" style="margin-left:4px;"> <a href="#"
                            class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner" style="display: flex;">
                                <div class="basket"> <i class="glyphicon glyphicon-shopping-cart"></i> </div>
                                <div class="basket-item-count"><span id="cartQty" class="count"></span></div>
                                <div class="total-price-basket"><span class="total-price"
                                        style="text-transform: lowercase;"> <span class="sign"></span><span
                                            id="cartSubTotal" class="value"></span>đ </span> </div>
                            </div>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('order.tracking') }}" method="POST">
                        ...
                        <button class="btn btn-danger" type="submit" style="margin-left: 16px;"> Track Now </button>
                    </form>
                </div>
            </div>
        </div>
...
@section('add-script')
    <script>
        function search_ajax_hide() {
            $("#searchProducts").slideUp();
        }

        function search_ajax_show() {
