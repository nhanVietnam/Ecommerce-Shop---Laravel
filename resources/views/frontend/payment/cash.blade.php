                ...
                <div class="row" style="justify-content: center; display: flex;">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="">
                                        <ul class="nav nav-checkout-progress list-unstyled">
                                            ...
                                            {{-- <li>
                                                @if (Session::has('coupon'))
                                                    <strong>Subtotal: </strong>
                                                    {{ str_replace(',', '.', number_format($cartTotal)) }}
                                                    <hr>
                                                    <strong>Coupon Name: </strong>
                                                    {{ session()->get('coupon')['coupon_name'] }}
                                                    ({{ session()->get('coupon')['coupon_discount'] }}%)
                                    ...
                                    <form action="{{ route('cash.order') }}" method="POST" id="payment-form">
                                        ...
                                        <button type="submit" class="btn-upper btn btn-primary checkout-page-button"
                                            style="width: 100%; text-align: center;">Thanh
                                            Toán </button>
                                    </form>
                    ...
                    <div class="checkout-progress-sidebar ">
                        <div class="panel-group">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="unicase-checkout-title">Thanh toán đơn hàng</h4>
                                    </div>
                                    <form action="{{ route('cash.order') }}" method="POST" id="payment-form">
                                        <div class="form-row">
                                            <img src="{{ asset('frontend/assets/images/payments/cash.png') }}" alt="">
                                        ...
                                        <input type="hidden" name="notes" value="{{ $data['notes'] }}">
                                        <input type="hidden" name="redirect">
                                        <button type="submit" class="btn-upper btn btn-primary checkout-page-button">Thanh
                                            Toán </button>
                                    </form>
                                </div>
                            </div>
