        ...
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                @foreach ($breadsubsubcat as $item)
                    <li class='active' style="white-space: nowrap;">{{ $item->category->category_name_en }}</li>
                @endforeach

                @foreach ($breadsubsubcat as $item)
                    <li class='active' style="white-space: nowrap;">{{ $item->subcategory->subcategory_name_en }}</li>
                @endforeach

                @foreach ($breadsubsubcat as $item)
                    <li class='active' style="white-space: nowrap;">{{ $item->subsubcategory_name_en }}</li>
                @endforeach
                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    ...
                                                    <div class="product-info text-left">
                                                        ...
                                                        @else
                                                            <div class="product-price"> <span class="price">
                                                                    {{ str_replace(',', '.', number_format($product->discount_price)) }}đ
