...
@section('content')
    ...
    <div class="container" style="height: 70vh; margin-top:30px;">
        <article class="card">
            ...
            <div class="card-body">
                <div class="row" style="margin-left: 30px; margin-top: 20px;">
                    ...
                    <div class="col-md-2">
                        <b> Total Amount </b><br>
                        {{ str_replace(',', '.', number_format($track->amount)) }}đ
                    </div> <!-- // end col md 2 -->
                ...
                <div class="track">
                    ...
                    @else
                        <div class="step active"> <span class="icon" style="background-color: red"> <i
                                    class="fa fa-close"></i> </span> <span class="text">Canceled</span>
                        </div>
                    @endif
                </div>
